...
Conclusion
======
As you can see, AdamW is not really useful in all cases compared to Adam and it probably depends a lot on the task at hand. The good practice is to always use Adam at first and then try AdamW to see if it improves the result (but keep in mind that in most cases, it probably won't do much).